...
const generateM3u = async (ud) => {
  ...
  for (let i = 0; i < chansList.length; i++) {
   m3uStr += '#EXTINF:-1 tvg-id="" tvg-name="NINJA TV" tvg-logo="https://ninjatv.lol/tata/copy.png" group-logo="https://ninjatv.lol/tata/copy.png" group-title="JOIN US @NINJATV",ROBIN HOOD\n';
